...
<h1 class=' my-5'> <a class='btn btn-primary me-5' href='addproduct.html' >Add Product</a>Prouduct Management</h1>
...
while ($rows = mysqli_fetch_assoc($result)) {
    ...
    <td><img src='products/{$rows['image']}' class='img-fluid rounded' style='max-width:100px'></td>
    <td>
        <a name='' id='' class='btn btn-danger' href='delete_product.php?id={$rows['id']}' role='button'>Delete</a>
    </td>
</tr>";
}
