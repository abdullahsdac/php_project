  ...
  <div class="container border-5 border border-dark my-5 p-5">
    ...
    <form action="updatereply.php" method="post">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control" name="number" id=""  value="<?php echo "{$row['number']}"; ?>" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Help text</small>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" name="reply" id="" rows="3"><?php echo "{$row['replied']}"?></textarea>
        </div>
